...
import com.spring.Shopsy.model.CartItem;
...
import com.spring.Shopsy.repository.ICartItemRepository;
...
public class CartService implements ICartService {
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        if (cartItem != null) {
            throw new ApiException("Product " + product.getProductName() + " already exists in the cart, please increase quantity");
        }
